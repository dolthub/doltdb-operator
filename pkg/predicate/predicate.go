...
// PredicateWithAnnotations returns a predicate that filters events based on the presence of specific annotations.
...
// PredicateWithLabel returns a predicate that filters events based on the presence of a specific label.
...
// hasAnnotations checks if the given object has all the specified annotations.
...
// hasLabel checks if the given object has the specified label.
